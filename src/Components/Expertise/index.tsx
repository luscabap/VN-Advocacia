      ...
      <div className="flex flex-col gap-8 my-8">
        <div className="border-2 border-solid border-darkColor rounded-xl p-4">
          <div className="flex flex-col items-center justify-center gap-2 mb-4">
            <GoGear size={50}/>
            <h4 className="uppercase text-terciaryColor underline">Melhor organização Empresarial</h4>
          </div>
        ...
        <div className="border-2 border-solid border-darkColor rounded-xl p-4">
          <div className="flex flex-col items-center justify-center gap-2 mb-4">
            ...
            <h4 className="uppercase text-terciaryColor underline">Proteção Patrimonial da Empresa</h4>
          </div>
        ...
        <div className="border-2 border-solid border-darkColor rounded-xl p-4">
          <div className="flex flex-col items-center justify-center gap-2 mb-4">
            ...
            <h4 className="uppercase text-terciaryColor underline">Menor desgaste emocional</h4>
          </div>
